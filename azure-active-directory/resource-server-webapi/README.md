...
1. Find the app key `ShowcaseApiBaseAddress` and set to `https://localhost:44372`
1. Find the app key `ShowcaseApiScope` and replace the existing value with the **App ID URI** of your web API, followed by "/.default".
