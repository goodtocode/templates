...
namespace MyCo.Identity.Daemon
{
    class Program
    {
        ...
        private static async Task RunAsync()
        {
            ...
            string[] scopes = new string[] { config.ShowcaseApiScope };
            ...
            if (result != null)
            {
                ...
                await apiCaller.CallWebApiAndProcessResultASync($"{config.ShowcaseApiBaseAddress}/api/todolist", result.AccessToken, Display);
            }
        }
