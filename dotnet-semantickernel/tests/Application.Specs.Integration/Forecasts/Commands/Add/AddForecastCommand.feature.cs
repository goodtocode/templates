...
namespace dotnet_semantickernel.Specs.Application.Integration.Forecasts.Commands.Add
{
    ...
    [NUnit.Framework.DescriptionAttribute("Add Forecast Command")]
    [NUnit.Framework.CategoryAttribute("addForecastCommand")]
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Add Forecast")]
        [NUnit.Framework.TestCaseAttribute("success", "Success", "", "038d8e7f-f18f-4a8e-8b3c-3b6a6889fed9", "false", "5/2/2023", "75", "92222, 93333", null)]
        [NUnit.Framework.TestCaseAttribute("bad request: empty key", "BadRequest", "Key", "", "false", "5/2/2023", "75", "", null)]
        [NUnit.Framework.TestCaseAttribute("bad request: empty TemperatureF", "BadRequest", "TemperatureF", "038d8e7f-f18f-4a8e-8b3c-3b6a6889fed9", "false", "5/3/2023", "", "92222", null)]
        [NUnit.Framework.TestCaseAttribute("bad request: empty date", "BadRequest", "Date", "038d8e7f-f18f-4a8e-8b3c-3b6a6889fed9", "false", "", "75", "92222, 93333", null)]
        [NUnit.Framework.TestCaseAttribute("already exists", "BadRequest", "Key", "038d8e7f-f18f-4a8e-8b3c-3b6a6889fed9", "true", "5/3/2023", "75", "92222, 93333", null)]
        public void AddForecast(string def, string response, string responseErrors, string key, string forecastExists, string date, string temperatureF, string zipcodes, string[] exampleTags)
        {
