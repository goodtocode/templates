...
#line 1 "UpdateForecastCommand.feature"
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Update Forecast")]
        ...
        public void UpdateForecast(string def, string response, string responseErrors, string key, string forecastExists, string date, string temperatureF, string zipcodes, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Update Forecast", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
